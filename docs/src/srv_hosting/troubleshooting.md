# Troubleshooting
## I can connect to my server directly, but it's not showing up on the server list!
...
- If you set `public_host`, make sure it points to the server and does not include a protocol (`http://`) or path.
